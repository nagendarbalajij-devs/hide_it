...
export const ViewMessage = (props) => {
	...
	return (
		<div className="my-4 flex w-full flex-row items-center justify-between rounded-md bg-red-50 py-2 px-2 shadow-sm transition ease-in-out hover:scale-105 hover:transition-all">
